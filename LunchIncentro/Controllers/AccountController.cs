...
namespace LunchIncentro.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public Vestiging GetUserVestiging(string name)
        {
            ...
            var uv = from u in UserManager.Users where u.UserName.Equals(name) select u.Vestiging;
            var v = from a in control.GetVestigingen() where a.Id.Equals(uv.FirstOrDefault()) select a;
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    var control = DependencyResolver.Current.GetService<VestigingsController>();
                    return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { Email = loginInfo.Email, Vestigingen = control.VestigingSelectList() });
            }
        }
